...
class SceneLoad extends Phaser.Scene {
  ...
  preload() {
    ...
    // 場景加載的資源
    this.load.image("bgTop", "./images/bg_top.png");
    this.load.image("bgMiddle", "./images/bg_middle.png");
    this.load.image("bgBottom", "./images/bg_bottom.png");
    this.load.image("boss1", "./images/boss1.png");
    this.load.image("boss2", "./images/boss2.png");
    this.load.image("goal", "./images/goal.png");
    this.load.image("superStar", "./images/superStar.png");
    this.load.spritesheet("ballSprite", "./images/ball_sprite.png", {
      frameWidth: 110,
      frameHeight: 110
    });
    this.load.spritesheet("duckSprite", "./images/duck_sprite.png", {
      frameWidth: 124,
      frameHeight: 150
    });
    this.load.spritesheet(
      "btnLeftSprite",
      "./images/btnLeft_sprite.png", {
        frameWidth: 50,
        frameHeight: 55
      }
    );
    this.load.spritesheet(
      "btnRightSprite",
      "./images/btnRight_sprite.png", {
        frameWidth: 50,
        frameHeight: 55
      }
    );
    this.load.spritesheet("btnStart", "./images/btnStart_sprite.png", {
      frameWidth: 150,
      frameHeight: 55
    });
    this.load.spritesheet("clearSprite", "./images/clear_sprite.png", {
      frameWidth: 190,
      frameHeight: 155
    });
  }
